...
if ($conn) {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'samruddhiproject47@gmail.com'; //your email
    $mail->Password = 'iyxlmvxbyqvbevwc'; //your password
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('samruddhiproject47@gmail.com'); //your gmail
    ...
    $mail->Subject = "FarmBook.com "; //$_POST["subject"]; // add subject \
